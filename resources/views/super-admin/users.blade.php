 ...
 <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#largeModal">
                ...
                <div class="modal-dialog" >
                  <div class="modal-content" >
                    <div class="modal-header  text-center  bg-primary">
                      <h5 class="modal-title" style="color:white">Patients' Details</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                   <div class="modal-body">
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-6">
         ...
         <div class="col-md-6">
            <p><strong><i class="fas fa-envelope"></i> Contact:</strong> {{ $user->patient->contact_number }}</p>
        </div>
            <div class="col-md-6">
                <p><strong><i class="fas fa-building"></i> Date of Birth:</strong> {{ $user->patient->dob }}</p>
            </div>
            <div class="col-md-6">
                <p><strong><i class="fas fa-graduation-cap"></i>Address:</strong> {{ $user->patient->address}}</p>
            </div>
