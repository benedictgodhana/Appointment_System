                  ...
                  <div class="modal-content" style="width:700px" >
                   ...
                   <div class="modal-body">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6">
                              <p><strong><i class="fas fa-envelope"></i> Contact:</strong> {{ $user->doctor->contact_number }}</p>
                          </div>

                             
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-graduation-cap"></i> Qualification:</strong> {{ $user->doctor->qualification }}</p>
                              </div>
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-stethoscope"></i> Specialization:</strong> {{ $user->doctor->specialization }}</p>
                              </div>
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-stethoscope"></i> Bio:</strong> {{ $user->doctor->bio }}</p>
                              </div>
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-stethoscope"></i> Address:</strong> {{ $user->doctor->address }}</p>
                              </div>
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-stethoscope"></i> Gender:</strong> {{ $user->doctor->gender}}</p>
                              </div>
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-stethoscope"></i> ID No.:</strong> {{ $user->doctor->identification_number}}</p>
                              </div>
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-stethoscope"></i> Availability:</strong> {{ $user->doctor->availability_schedule}}</p>
                              </div>
                              <div class="col-md-6">
                                  <p><strong><i class="fas fa-stethoscope"></i> Appointment Preferences:</strong> {{ $user->doctor->appointment_preferences}}</p>
                              </div>
