...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Famedical</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <a class="nav-link" href="{{ route('superAdminUsers') }}">
        <i class="bi bi-person fs-4"></i><span>Patients</span>
    </a>
</li>
<li>
    <a class="nav-link" href="{{ route('superAdminDoctors') }}">
        <i class="bi bi-file-earmark-medical fs-4"></i><span>Doctors</span>
    </a>
</li>
<li>
    <a class="nav-link" href="{{ route('manageRole') }}">
      ...
      <li class="nav-item">
        ...
        <li>
          <a class="nav-link" href="{{ route('sadminreservation') }}">
              <i class="bi bi-calendar2-check fs-4"></i><span>Today's Appointments</span>
          </a>
      </li>
      <li>
          <a class="nav-link" href="forms-layouts.html">
              <i class="bi bi-calendar2 fs-4"></i><span>All Appointments</span>
          </a>
      </li>
      <li>
          <a class="nav-link" href="forms-editors.html">
              <i class="bi bi-check2 fs-4"></i><span>Accepted Appointments</span>
          </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link " href="{{ route('superadminactivities') }}">
      ...
      <li class="nav-item">
        ...
        <li>
          <a class="nav-link" href="{{ route('subadminreservation') }}">
              <i class="bi bi-calendar2-check fs-4"></i><span>All Appointments</span>
          </a>
      </li>
      <li>
          <a class="nav-link" href="forms-layouts.html">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Famedical</span></strong>. All Rights Reserved
    </div>
