...
class ReservationController extends Controller
{
    public function storeReservation(Request $request)
    {
        ...
        $recipientEmail = 'bdhadho@strathmore.edu';
        Mail::to($recipientEmail)->send(new ReservationConfirmation($reservation));
        // Send email notification to authenticated user
    
        // Send email notification to selected doctor
        $doctorEmail = User::findOrFail($validatedData['doctorName'])->email;
        Mail::to($doctorEmail)->send(new ReservationConfirmationDoctor($reservation));
