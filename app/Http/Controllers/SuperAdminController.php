    ...
    public function dashboard()
{
    ...
    return view('super-admin.dashboard', compact('patientCount', 'doctorCount','appointmentCount','activities'));
}
...
return back()->with('success', 'User and patient information added successfully.');    
    ...
    public function reservation()
    {
        ...
        $doctors=Doctor::all();
        return view('super-admin.reservation', compact('appointments', 'acceptedReservations', 'pendingReservations','doctors'));
    }
